...
var AudioPlayer = function () {
	...
	return {
		...
		embed: function (elementID, options) {
			...
			console.clear();
			console.log("hello");
			console.log(instanceOptions.width);

			instanceOptions.width = 290;
			if( (instanceOptions.width % 1) != 0) {

				audioplayer_swfobject.embedSWF(playerURL, elementID, instanceOptions.width.toString().split(".")[0], "24", requiredFlashVersion, false, flashVars, flashParams, flashAttributes);
			}
			else {
